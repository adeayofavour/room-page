...
const slides = [
 {
   ...
   text: "We provide unmatched quality, comfort, and style for property owners across the country. Our experts combine form and vision to life. Create a room in your own style with our collection and make your property a reflection of you and what you love."
 }, 
 {
...
function show() {
  ...
  mainPhoto.style.minHeight = "370px";
  mainPhoto.style.width = "100%";
  mainPhoto.style.transition = "all 3s ease-out";
}
show();
